...
class ContractAdmin(admin.ModelAdmin):
    list_display = [
        'title', 'contract_number', 'contract_type', 'status', 'party_b',
        'start_date', 'end_date', 'days_until_expiry',
        'owner', 'created_at'
    ]
    list_filter = [
        'status', 'contract_type', 'issuing_company_name', 'auto_renew',
        'created_at', 'start_date', 'end_date'
    ]
    search_fields = ['title', 'contract_number', 'party_a', 'party_b', 'issuing_company_name', 'description']
    readonly_fields = [
        'contract_number', 'created_at', 'updated_at', 'created_by',
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('title', 'contract_number', 'contract_type', 'description', 'status')
        }),
        ('Parties', {
            'fields': ('party_a', 'party_b', 'issuing_company_name', 'issuing_company_code')
        }),
        ('Financial', {
...
class ContractNumberSequenceAdmin(admin.ModelAdmin):
    ...
    list_filter = ['contract_type_code', 'year', 'company_key']
